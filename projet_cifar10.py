...
# Obviously, if you want to try with you own images, you can use the following code, replacing PATH.JPG by your path to the JPG image :
'''
test_image_1 = image.load_img('PATH.JPG', target_size = (32, 32))
test_image = image.img_to_array(test_image_1)
test_image = np.expand_dims(test_image, axis = 0) 
result = model.predict(test_image) 
print(result) 
...
plt.imshow(test_image_1)
# Is your image correctly predicted ?
'''
